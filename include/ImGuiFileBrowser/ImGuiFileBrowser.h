    ...
    class ImGuiFileBrowser
    {
        public:
            ...
            bool showFileDialog(const std::string& label, const DialogMode mode, const ImVec2& sz_xy = ImVec2(0,0),
                const std::string& valid_types = "*.*", const std::string& startingPath = "");
        ...
        private:
            ...
            void filterFiles(size_t filter_mode);
            ...
            size_t filter_mode, col_items_limit, selected_idx, selected_ext_idx;
